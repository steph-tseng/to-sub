...
from tensorflow.keras.layers import Dense, Input, LSTM, Conv1D, Conv2D, Dropout, Flatten, Activation, MaxPooling2D, BatchNormalization
...
def train_ann():
    ...
    filename = os.path.join(STORE_DIR, 'dataset.pickle')
    print(filename)
    ...
    print('val_acc:', max(hist.history['val_accuracy']))
